...
create_camera_control (void)
{
  ...
  GObject *img_exp_spin_adj;
  GtkWidget *img_exp_spin;
  GObject *img_width_spin_adj;
  GtkWidget *img_width_spin;
  GObject *img_height_spin_adj;
  GtkWidget *img_height_spin;
  GObject *img_x_skip_spin_adj;
  GtkWidget *img_x_skip_spin;
  GObject *img_y_skip_spin_adj;
  ...
  GtkWidget *label29;
  GtkWidget *label30;
  GObject *file_seqn_spin_adj;
  GtkWidget *file_seqn_spin;
  GObject *img_number_spin_adj;
  ...
  GtkWidget *label32;
  GtkWidget *label33;
  GObject *cooler_tempset_spin_adj;
...
create_image_processing (void)
{
  ...
  GtkWidget *frame7;
  GtkWidget *hbox19;
  GObject *mul_spin_adj;
  GtkWidget *mul_spin;
  GtkWidget *mul_checkb;
  GObject *add_spin_adj;
  GtkWidget *add_spin;
  ...
  GObject *stack_sigmas_spin_adj;
  GtkWidget *stack_sigmas_spin;
  GObject *stack_iter_spin_adj;
